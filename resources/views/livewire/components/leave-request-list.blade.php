...
@forelse ($leaveRequests as $request)
            <!-- 1. Tambahkan flex, flex-col, dan h-full pada card -->
            <flux:card class="px-4 py-4 flex flex-col h-full"> 
                
                <!-- 2. Bungkus semua konten bagian atas ke dalam div dengan class flex-1 -->
                <div class="flex-1 flex flex-col">
                    ...
                    @if ($request->status === 'rejected')
                        <div class="mt-4 pl-3 py-1 border-l-2 border-red-400 flex flex-col gap-1">
                    ...
                    @endif
                </div> <!-- Akhir dari pembungkus konten atas (flex-1) -->

                <!-- 3. Footer Approver (Secara otomatis akan terdorong ke bawah) -->
                @if ($request->status !== 'pending')
                ...
                @else
                    <!-- Spacer opsional untuk menjaga keseimbangan tinggi card jika statusnya pending (tanpa footer) -->
                    <div class="mt-4 pt-3 border-t border-transparent"></div>
                @endif
            </flux:card>
